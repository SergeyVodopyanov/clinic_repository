...
use App\Http\Requests\Patient\Patient\UpdateRequest;
...
{
    public function __invoke(UpdateRequest $request, Patient $patient, User $user)
    {
        ...
        return redirect()->route('patient.account.index', compact('patient'));
    }
