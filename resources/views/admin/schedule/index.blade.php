            ...
            <div class="container-fluid"> <!-- Small boxes (Stat box) -->
                <div class="row">
                    <div class="col-1 mb-3">
                        <a href="{{ route('admin.schedule.create') }}" class="btn btn-block btn-primary">
                            Добавить
                        </a>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <div class="card-body table-responsive p-0">
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tr>
                                        <td>{{ $schedule->doctor->doctor_surname . " " . $schedule->doctor->doctor_name . " " . $schedule->doctor->doctor_middlename }}</td>
